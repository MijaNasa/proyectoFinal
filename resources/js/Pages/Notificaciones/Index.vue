                        ...
                        >
                            <div class="flex items-start gap-4">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <template v-else-if="notif.data.type === 'nueva_venta'">
                                        <p class="text-sm font-semibold text-white leading-relaxed">
                                            ...
                                            <span v-if="notif.data.message" class="text-zinc-300 font-normal">
                                                {{ notif.data.message.replace(/^Nueva venta #\d+\s*/i, ' — ') }}
                                            </span>
                                        </p>
                                        <Link 
                                            :href="getVentaUrl(notif)" 
