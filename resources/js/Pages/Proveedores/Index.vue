...
const toggleProveedor = (proveedor) => {
    if (proveedor.activo) {
        darkSwal.fire({
            ...
            text: "El proveedor se marcará como inactivo y no estará disponible para nuevas compras ni operaciones.",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                router.patch(route('proveedores.toggleActivo', proveedor.id), {}, {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        ...
                        if (errorMsg) {
                            ...
                            darkSwal.fire({
                                title: '¡Desactivado!',
                                text: page.props.flash?.message || 'El proveedor fue desactivado correctamente.',
                                icon: 'success',
                                timer: 1500,
                                showConfirmButton: false
                            });
        ...
        router.patch(route('proveedores.toggleActivo', proveedor.id), {}, {
            ...
            onSuccess: (page) => {
                darkSwal.fire({
                    title: '¡Reactivado!',
                    text: page.props.flash?.message || 'El proveedor fue reactivado correctamente.',
                    icon: 'success',
                    timer: 1500,
                    showConfirmButton: false
                });
                                    ...
                                    <td class="p-4 text-right">
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            <button 
                                                ...
                                                @click="toggleProveedor(proveedor)" 
